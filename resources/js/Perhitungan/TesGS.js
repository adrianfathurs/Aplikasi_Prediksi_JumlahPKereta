export const hitung = async(payload) =>{
  ...
  //deklarasi parameter alpha(mempengaruhi level),beta(mempengaruhi trend),gamma(mempengaruhi seansonality)
    ...
    let T=[];
    let S=[];
    //Y yang bener yang ini
    /* let Y=payload; */
    let Y=[16446,14519,16584,16031,17018,16806,17632,14492,16353,16062,15765,16333,15801,15126,16701,16376,17401,17687,
...
33472,31679,22949,5813,5476,9272,12205,12679,11295,11768,13523,13262,11631,11223,13995,14590];//data actual
  ...
  */
  ...
  var iteration=30;//jumlah iterasi
  ...
  /* diandaikan bahwa hitung fungsi ini adalah triple exponential smoothing */
  function hitungFungsi(paramsalpha){
    var hasilFungsi = paramsalpha*3/9;
    return hasilFungsi;
  ...
  console.log("E",hasilFungsiE, " F",hasilFungsiF)
  console.log("G",hasilFungsiG, " H",hasilFungsiH)  */
  console.log("ini hasil Mape ops",hasilMapeOps) 
  var ress=hasilMapeOps.sort(function(a, b){
    return a.hasil-b.hasil
  })
  hasilMapeOps.push(ress[0]);
  return hasilMapeOps;
